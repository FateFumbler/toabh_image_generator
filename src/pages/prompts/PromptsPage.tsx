    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage and organize your image generation prompts</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {showLeftArrow && (
            <button
              ...
              className="flex-shrink-0 p-2 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg transition-colors"
            >
          ...
          <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex items-end">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <Star className={cn("w-4 h-4", favoritesOnly ? "text-amber-400 fill-amber-400" : "text-slate-400 dark:text-slate-500")} />
              </label>
            </div>
          </div>
        )}
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-4">
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-slate-700 dark:text-slate-300 mr-2">Gender:</span>
          <button
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={8} className="px-4 py-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-slate-900 dark:text-white">No prompts found</h3>
                ...
                filteredPrompts.map((prompt) => (
                  <tr 
                    ...
                    className={cn(
                      ...
                      selectedPrompts.includes(prompt.id) && "bg-indigo-50/50 dark:bg-indigo-950/50"
                    )}
                  >
                    ...
                    <td className="px-4 py-4 text-sm text-slate-600 dark:text-slate-300 max-w-md">
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-md w-full p-6">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Delete Prompt</h3>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 dark:bg-indigo-700 dark:hover:bg-indigo-800 transition-colors"
            >
...
function BulkAddModal({ categories, onClose, onSuccess }: BulkAddModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Bulk Add Prompts</h3>
          <button onClick={onClose} className="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg">
            <X className="w-5 h-5 text-slate-500 dark:text-slate-400" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <p className="text-sm text-blue-700 dark:text-blue-300">
              Enter one prompt per line. Format: <code className="bg-blue-100 dark:bg-blue-900 px-1 py-0.5 rounded">Theme: Description</code> or just the description.
            </p>
          </div>
          
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Prompts</label>
            <textarea
              required
              rows={10}
              value={text}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 
                         dark:bg-indigo-700 dark:hover:bg-indigo-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed
